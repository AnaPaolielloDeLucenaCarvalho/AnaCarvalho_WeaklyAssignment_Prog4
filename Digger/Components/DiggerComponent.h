...
namespace dae
{
    ...
    public:
        ...
        { 
            m_Lives = lives; m_Subject.Notify(make_sdbm_hash("PlayerDied"), m_Lives); 
        }
        ...
        { 
            m_pHighScoreManager = pMgr; 
        }
        HighScoreManager* GetHighScoreManager() const 
        { 
            return m_pHighScoreManager; 
        }
        ...
        { 
            m_TotalEnemiesForLevel = total; 
        }
        int GetTotalEnemiesForLevel() const 
        { 
            return m_TotalEnemiesForLevel; 
        }
